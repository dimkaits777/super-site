 ...
 * satisfies the deployment hardening requirement. This GLB is the procedural
 * FALLBACK model; real models are wired by hand in `src/config/models.js`
 * (which this script intentionally never overwrites).
 *
...
console.log(`✓ generated fallback model public/models/${fileName} (${glb.length} bytes)`);
console.log('✓ wrote public/models/manifest.json');
console.log('  (src/config/models.js is hand-edited and left untouched)');
